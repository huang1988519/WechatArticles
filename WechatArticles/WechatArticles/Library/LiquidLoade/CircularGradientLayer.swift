...
class CircularGradientLayer : CALayer {
    ...
    override func drawInContext(ctx: CGContext) {
        ...
        CGContextDrawRadialGradient(ctx, gradients, self.frame.center, CGFloat(0.0), self.frame.center, max(self.frame.width, self.frame.height), .DrawsBeforeStartLocation)
    }
}
